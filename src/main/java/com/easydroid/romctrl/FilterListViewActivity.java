...
public class FilterListViewActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (getFilter==Freeze.SYS_APP) {
			actionBar.setTitle(R.string.sys_app);
		}else if(getFilter==Freeze.USERS_APP) {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (item.getItemId()==android.R.id.home) {
			Intent intent = new Intent(getBaseContext(), Freeze.class);
