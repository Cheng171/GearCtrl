...
public class BatDigital extends Activity implements OnClickListener
{
	...
	public void onCreate(Bundle savedInstanceState) {
	{
		...
		setContentView(R.layout.batdigital);
		init();
	}}
	...
	public void onWindowFocusChanged(boolean hasFocus) {
		...
		if(hasFocus){
			...
			int bigimgHei = bigimg.getHeight();
			big.setHeight(bigimgHei);
			
			ImageView smallimg = (ImageView) findViewById(R.id.smallimg);
			small.setHeight(smallimg.getHeight());
			
			ImageView nodigImg = (ImageView) findViewById(R.id.nodigimg);
			nodig.setHeight(nodigImg.getHeight());
...
execShell("killall com.android.systemui");		
		break;
			case R.id.big:
				//电量内显大
execShell("sh system/vendor/gearmagic/statusbar/big.sh");		
execShell("killall com.android.systemui");		
	break;
			case R.id.small:
				//电量内显小
execShell("sh /system/vendor/gearmagic/statusbar/small.sh");			
execShell("killall com.android.systemui");		
break;
		}
	}
