...
public class zhagan extends Activity implements OnClickListener
{
	private Button swap,unswap,makeswap256,makeswap128;
	//private TextView tv;
	@Override
	public void onCreate(Bundle savedInstanceState) {
	{
		...
		setContentView(R.layout.zhagan);
		init();
	}}
	...
	public void onClick(View view){
		switch(view.getId()){
			case R.id.xingnengswap:
				//永久关闭
				execShell("mount -o remount,rw /system");
				execShell("echo 0 > /sys/android_touch/doubletap2wake ");
				execShell("echo echo 0 > /sys/android_touch/doubletap2wake > /system/etc/init.qcom.post_boot.sh");
		break;
			...
			Toast.makeText(zhagan.this,"此功能可能会对电池有一定程度的损伤！ \n 不到万不得已不推荐使用！",Toast.LENGTH_SHORT).show();
			break;
	...
	public boolean joinQQGroup(String key) {
		...
		try {
			...
			// 未安装手Q或安装的版本不支持
			Toast.makeText(zhagan.this,"跳转失败，您未安装手机QQ或者QQ版本过低，",Toast.LENGTH_SHORT).show();
			return false;
		}
	}
